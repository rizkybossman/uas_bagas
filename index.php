            ...
            <div class="card-body">
                ...
                <form class="row g-3" action="tambah.php" method="POST">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="nama" class="form-control" placeholder="Bagas Aryatama" required>
                    </div>
                    <div class="col-md-4">
                        <label for="NIM" class="form-label">NIM</label>
                        <input type="text" name="NIM" class="form-control" placeholder="21552011121" required>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="jurusan" class="form-control" placeholder="Teknik Informatika" required>
                    </div>

                    <div class="col-md-6">
                        <label for="IPK" class="form-label">IPK</label>
                        <input type="number" step=0.01 name="IPK" class=" form-control" placeholder="6.9" required>
                    </div>
